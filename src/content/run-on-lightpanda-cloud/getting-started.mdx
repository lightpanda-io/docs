...
The same URL takes a [`proxy` parameter](/guides/configure-a-proxy#use-a-proxy-on-lightpanda-cloud) to route the session through a shared proxy, or through one you added on the [proxies page](https://console.lightpanda.io/proxies) in the console.
