---
title: MCP
description: Control Lightpanda cloud offer using Model Context Protocol
---
...
Use the url `https://cloud.lightpanda.io/mcp/sse` to connect.
...
```
https://cloud.lightpanda.io/mcp/sse?token=TOKEN
```

Example with the Bearer HTTP header.
```
https://cloud.lightpanda.io/mcp/sse
...
For more advanced use cases, you can use [CDP](/cloud-offer/services/cdp) connection with [Playwright MCP](https://github.com/microsoft/playwright-mcp).
