...
- **A timeout** doesn't fail: `"Navigation started but the page did not finish loading before the timeout."`
- **An HTTP error page** (404, 500, ...) is still a successful navigation at the network level: `"Navigated successfully."` Check the content result to tell an error page from real content.
