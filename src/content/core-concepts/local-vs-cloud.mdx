...
<Callout type="info">
Cloud coverage is a work in progress. The cloud exposes the MCP server over SSE with a subset of the tools available locally.
</Callout>
...
| [Proxies](/guides/configure-a-proxy) | Yes, your own proxy | Yes, shared pool with country selection, or your own |
