...
> For full MCP server documentation — tools, resources, handshake protocol, agent configuration, and HTTP transport — see the [MCP server guide](/usage/mcp) and the [MCP tools reference](/reference/mcp-tools).
