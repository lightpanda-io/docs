...
In this example, you’ll connect [Puppeteer](https://pptr.dev/) to Lightpanda
...
Next step: [Build your first data extraction script](/quickstart/build-your-first-extraction-script)
